...
<div class="wrap">
	...
	<div class="interest">
		...
		<div class="swiper-box">
		    <swiper :options="swiperOption">
		        <swiper-slide v-for="date in intersets" :key="date.id">
	...
	<div class="interest quanzi">
		...
		<div class="swiper-box">
		    <swiper :options="swiperOption1">
		        <swiper-slide class="show" v-for="date in tuhao" :key="date.id">
		        	<div @click="util.toast" class="item">
	...
	<div class="interest quanzi ">
		...
		<div class="swiper-box">
		    <swiper :options="swiperOption1">
		        <swiper-slide class="show" v-for="date in chinas" :key="date.id">
		        	<div @click="util.toast" class="item">
			        	<div class="imgdisplay" v-if="date.img !== undefined ">
							<img class="imgbig" :src="date.img" alt="">
						</div>
