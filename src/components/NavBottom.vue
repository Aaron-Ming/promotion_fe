<template>
	<div class="footer">
		<div  class="item item2" :class="{icon11: footerIndex === 0, icon1: footerIndex !== 0}" @click="tohome">首页</div>
	    <div  class="item item2" :class="{icon22: footerIndex === 1, icon2: footerIndex !== 1}" @click="yutang">分类</div>
		<!--
	    <div class="item item1" >
			<div class="outbox" >
				<span class="open" @click="change1"></span>
			</div>
			<p class="commit">发布</p>
		</div>
		-->
